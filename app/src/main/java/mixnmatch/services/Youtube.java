...
public class Youtube {
	...
	public static Credential authorize(final NetHttpTransport httpTransport) throws IOException {
		// Load client secrets
		InputStream in = Youtube.class.getResourceAsStream(CLIENT_SECRETS);
		assert in != null;
	...
	public void exportPlaylists(){
        try {
			...
			System.out.println("Hi from services");
	...
	private YouTube youtubeService() throws IOException, GeneralSecurityException {
		// Build a new authorized API client service.
		final NetHttpTransport httpTransport = GoogleNetHttpTransport.newTrustedTransport();
		return new YouTube.Builder(httpTransport, JSON_FACTORY, authorize(httpTransport))
